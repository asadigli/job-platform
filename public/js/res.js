...
function get_url(url){
  var ids = ["contact", "home"];
  document.getElementById(url).style.display = "";
  setCookie("url_link", url, 4000);
  document.getElementById(ids[Math.abs(ids.indexOf(url) - 1)]).style.display = "none";
}
if (getCookie("url_link") != "") {
  window.load = get_url(getCookie("url_link"));
}else{window.load = get_url('home');}
