...
@if(Request::is('company/*') && Request::is('*/vacancies'))
<title>{{$comp}} - {{__('app.Jobs')}}</title>
@elseif(Request::is('user/*') && Request::is('*/vacancies'))
<title>{{$us}} - {{__('app.Jobs')}}</title>
@elseif(Request::is('location/*') && Request::is('*/vacancies'))
<title>{{$region}} - {{__('app.Jobs')}}</title>
@endif
@endsection
@section('body')
